...
window.addEventListener("load", function () {
	...
	$("speed").addEventListener("click", function () {
		do {
			userSpeed = parseInt(window.prompt("The current speed is " + slideshow.getSpeed() + "\nPlease enter a new value of speed to change speed."), 10);
		} while (validate(userSpeed) === false);
		slideshow.setSpeed(userSpeed).startSlideShow();
	});
